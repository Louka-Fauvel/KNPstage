          ...
          if ($chiff1>10 && $chiff1<=100) {
            if ($chiff1>$chiff2) {
              if ($chiff2!=0) {
                ...
                exit("<p>Erreur le deuxième nombre ne doit pas être égale à 0.</p>");
              }
            }else {
              exit("<p>Erreur le premier nombre doit être plus grand que le deuxième nombre.</p>");
            }
          }else {
            exit("<p>Erreur le premier nombre doit être compris entre 10 et 100 inclus</p>");
          }
